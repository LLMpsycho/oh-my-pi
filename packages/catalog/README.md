...
Model catalog for [oh-my-pi](https://github.com/LLMpsycho/oh-my-pi): bundled model database, provider discovery, model identity, classification, and equivalence.
...
- [Monorepo README](https://github.com/LLMpsycho/oh-my-pi#readme)
